...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Parse.setApplicationId("instaParse", clientKey: "q34jt43j6y5345w98oeuyrhoeiurydgvp98o9384w-489ryfwej")
        
        Parse.initializeWithConfiguration(
            ParseClientConfiguration(block: { (configuration:ParseMutableClientConfiguration) -> Void in
                configuration.applicationId = "instaParse"
                configuration.clientKey = "q34jt43j6y5345w98oeuyrhoeiurydgvp98o9384w-489ryfwej"
                configuration.server = "https://agile-beyond-73038.herokuapp.com/parse"
            })
        )
